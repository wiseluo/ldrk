...
class UtilService
{
    ...
    public static function setShareMarketingPoster($data = array(), $path)
    {
        $config = array(
            ...
            'background' => public_path() . 'statics/poster/poster.jpg'
        );
     ...
     * @return array|bool|string
     */
    public static function getQRCodePath($url, $name,$qrcode_type='')
    {
        ...
        try {
            ...
            $info = [];
            $outfiles = $qrcode_type == '' ? Config::get('qrcode.cache_dir') : Config::get('qrcode.cache_dir').'/'.$qrcode_type;
    ...
    public static function getQrcodeBase64($url,$colorCode=''){
        if($colorCode == 'green'){
            $foregroundColor = new Color(108, 170, 114);
