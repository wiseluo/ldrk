...
trait JwtAuthModelTrait
{
    ...
    public function getToken(string $type, array $params = []): array
    {
        ...
        $token = JWT::encode($params, Env::get('app.app_key', 'c16191b39e5759a46be5ba9f66d94cda')); //md5('yxtproadmin')
    ...
    public static function parseToken(string $jwt): array
    {
        ...
        $data = JWT::decode($jwt, Env::get('app.app_key', 'c16191b39e5759a46be5ba9f66d94cda'), array('HS256'));
