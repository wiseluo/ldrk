...
class Captcha
{
    ...
    public function create(array $generator = null): Response
    {
        ...
        // 验证码使用随机字体
        $ttfPath = dirname(dirname(app()->getThinkPath())) . DIRECTORY_SEPARATOR . 'think-captcha' . DIRECTORY_SEPARATOR . 'assets/' . ($this->useZh ? 'zhttfs' : 'ttfs') . '/';
    ...
    {
        $path = dirname(dirname(app()->getThinkPath())) . DIRECTORY_SEPARATOR . 'think-captcha' . DIRECTORY_SEPARATOR . '/assets/bgs/';
        $dir = dir($path);
