...
abstract class BaseController
{
    ...
    protected function success($msg = 'ok', ?array $data = null): Response
    {
        return app('json')->success($msg,$data);
    }

    protected function fail($msg = 'fail', ?array $data = null): Response
    {
        return app('json')->fail($msg,$data);
    }

    protected function validate($data, $class, $scene='')
    {
        try {
