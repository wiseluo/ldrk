...
class OwnDeclareValidate extends Validate
{
    ...
    protected $scene = [
        'leaveDeclare' => ['province_id', 'province', 'city_id', 'city', 'county_id', 'county', 'leave_time', 'expect_return_time'],
        'comeDeclare' => ['province_id', 'province', 'city_id', 'city', 'county_id', 'county', 'yw_street_id', 'yw_street', 'address', 'arrival_time', 'travel_img', 'has_report'],
        'riskareaDeclare' => ['province_id', 'province', 'city_id', 'city', 'county_id', 'county', 'leave_riskarea_time', 'yw_street_id', 'yw_street', 'address', 'arrival_time', 'arrival_transport_mode', 'arrival_sign', 'travel_img', 'has_report'],
        'barrierDeclare' => ['district_id', 'yw_street_id', 'yw_street', 'isasterisk'],
        'resultWhole' => ['id'],
    ];
