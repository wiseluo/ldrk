...
class SystemAdminDao extends BaseDao
{
    ...
    public function accountByZZDOpenid(string $zzd_openid)
    {
        return $this->search(['zzd_openid' => $zzd_openid, 'is_del' => 0, 'status' => 1])->find();
    }
     ...
     * @return int
     */
    public function isAccountUseable(string $account, int $id)
    {
